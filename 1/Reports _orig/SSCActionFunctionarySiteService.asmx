<%@ webservice language="C#" class="SSCActionFunctionarySiteService" %>          
...
public class SSCActionFunctionarySiteService : ReportServiceBase                 
{
...
//---------------------------------------------------------------
        ...
        public List<eArm> GetListArms()
        {
            ...
            sql_conn.Open();
            adArm.SelectCommand = new SqlCommand(@"select id,Name,(select (select id from Elements Where id = el2.parent) from Elements as el2 Where id = el1.parent) from Elements as el1 Where class LIKE 'SSCComp' AND parent > 0", sql_conn);
...
//---------------------------------------------------------------
    ...
    public SSCActionFunctionarySiteService()                                     
    {
