<%@ webservice language="C#" class="SSCSecondaryNetworkStateService" %>
...
public class SSCSecondaryNetworkStateService : ReportServiceBase
{
    ...
    public static int IdSite = 0;

    [System.Web.Services.WebMethod()]
    public double SendParamReport(DateTime DateBegin, DateTime DateEnd,int id_vp,string callsign , bool IsArchive, int idsite)
    {
        Callsign = callsign;
    ...
    public SSCSecondaryNetworkStateService()                                     
    {
        ReportDoc.FileName = this.Server.MapPath("SSCSecondaryNetworkState.rpt");
    ...
    private void LoadData()                                  
    {
        ...
        ParameterDiscreteValue val_idsite = new ParameterDiscreteValue();
        ...
        val_idsite.Value = IdSite;
        val_callsign.Value = Callsign;
        ReportDoc.SetParameterValue(@"@dayB", val_dateB);
        ReportDoc.SetParameterValue(@"@dayE", val_dateE);
        ReportDoc.SetParameterValue(@"@id_vp", val_idvp);
        ReportDoc.SetParameterValue(@"@idSite", val_idsite);
