<%@ webservice language="C#" class="DutiesReportService" %>
...
public class DutiesReportService : ReportServiceBase
{
    //---------------------------------------------------------------
    ...
    public DutiesReportService()
    {
        ReportDoc.FileName = this.Server.MapPath("DutiesReport.rpt");
