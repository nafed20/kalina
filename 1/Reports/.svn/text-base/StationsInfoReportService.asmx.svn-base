<%@ webservice language="C#" class="StationsInfoReportService" %>
...
public class StationsInfoReportService : ReportServiceBase
{
    ...
    public StationsInfoReportService()
    {
        //
        // TODO: Add any constructor code required
        // 
        //mainService = new Service();//?
        ReportDoc.FileName = this.Server.MapPath("StationsInfoReport.rpt");
        LoadData();
    ...
    private void LogOn()
    {
        ...
        ////DateTime ttt = CachingData.DateBegin;
        //string dateString = Convert.ToString(CachingData.DateBegin);  //public static string ToString(DateTime value)
        //string[] lines = { dateString };
