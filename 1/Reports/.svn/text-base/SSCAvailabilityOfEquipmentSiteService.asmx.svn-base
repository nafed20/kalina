<%@ webservice language="C#" class="AvailabilityOfEquipmentSiteServiceSSC" %>          
...
public class AvailabilityOfEquipmentSiteServiceSSC : ReportServiceBase                 
{
...
//---------------------------------------------------------------
    ...
    public AvailabilityOfEquipmentSiteServiceSSC()                                     
    {
        ReportDoc.FileName = this.Server.MapPath("SSCAvailabilityOfEquipmentSite.rpt");
