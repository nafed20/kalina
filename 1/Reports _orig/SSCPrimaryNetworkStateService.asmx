<%@ webservice language="C#" class="SSCPrimaryNetworkStateService" %>
...
public class SSCPrimaryNetworkStateService : ReportServiceBase
{
    ...
    public SSCPrimaryNetworkStateService()                                     
    {
        ReportDoc.FileName = this.Server.MapPath("SSCPrimaryNetworkState.rpt");
