<%@ WebService Language="C#" CodeBehind="MagReportsDC.asmx.cs" Class="WebServiceAcontur.MagReportsDC" %>
using System;
...
namespace WebServiceAcontur
{
    ...
    public class MagReportsDC : ReportServiceBase
    {
    // --------- параметры службы -----------------------
   ...
   // private ConnectionInfo connectInfo;
    ...
    public MagReportsDC()
    {
        report.FileName = this.Server.MapPath("MagazineWatchReport.rpt");
       

            conectionstring = ConfigurationManager.ConnectionStrings[0].ConnectionString;
        //conectionstring = @"Data Source=localhost\SQLExpress;user=sa;password=smart;database=ACSSnew";
