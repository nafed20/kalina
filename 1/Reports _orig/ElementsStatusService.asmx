<%@ webservice language="C#" class="ElementsStatusService" %>
...
public class ElementsStatusService : ReportServiceBase
{
    ...
    public ElementsStatusService()
    {
        //
        // TODO: Add any constructor code required
        // 
        //mainService = new Service();
        ReportDoc.FileName = this.Server.MapPath("ElementsStatus.rpt");
        LoadData();
    ...
    private void LoadData()
    {
        ...
        parameterFieldDefinition = parameterFieldDefinitions[CALL_SIGN_FIELD];
        parameterFieldDefinition.ApplyCurrentValues(currentParameterValues);
       

        currentParameterValues = new ParameterValues();
        parameterDiscreteValue = new ParameterDiscreteValue();
        parameterDiscreteValue.Value = CachingData.SiteId;
        currentParameterValues.Add(parameterDiscreteValue);
    ...
    private void LogOn()
    {
        ...
        //string dataString = Convert.ToString(CachingData.SiteId);  //SiteId   public static string ToString(DateTime value)
        //string dataString = CachingData.CallSign;
