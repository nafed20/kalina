<%@ webservice language="C#" class="CapacityService" %>
...
public class CapacityService : ReportServiceBase
{
    ...
    public double SendData4(DateTime DateBegin, DateTime DateEnd, bool IsArchive)
    {
    ...
    {
        ReportDoc.FileName = this.Server.MapPath("Capacity.rpt");
