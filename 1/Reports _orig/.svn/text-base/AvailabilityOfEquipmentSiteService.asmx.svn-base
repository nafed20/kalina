<%@ webservice language="C#" class="AvailabilityOfEquipmentSiteService" %>          
...
public class AvailabilityOfEquipmentSiteService : ReportServiceBase                 
{
...
//---------------------------------------------------------------
    ...
    public AvailabilityOfEquipmentSiteService()                                     
    {                 
        ReportDoc.FileName = this.Server.MapPath("AvailabilityOfEquipmentSite.rpt");
