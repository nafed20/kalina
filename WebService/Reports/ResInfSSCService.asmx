<%@ webservice language="C#" class="ResInfSSCService" %>
...
public class ResInfSSCService : ReportServiceBase
{
    ...
    public ResInfSSCService()                                     
    {
        ReportDoc.FileName = this.Server.MapPath("ResInfSSC.rpt");
